...
public class QuizListAdapter extends RecyclerView.Adapter<QuizListAdapter.QuizViewHolder> {
    ...
    public void onBindViewHolder(@NonNull QuizViewHolder holder, int position) {
        ...
        String listDecription =quizListModels.get(position).getDesc();
        if (listDecription.length()>150){
            listDecription =listDecription.substring(0,150);

        }
        holder.listDesc.setText(listDecription +"....") ;
    ...
    public class QuizViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public QuizViewHolder(@NonNull View itemView) {
            super(itemView);
             ...
             listLevel=itemView.findViewById(R.id.list_diffculity);
